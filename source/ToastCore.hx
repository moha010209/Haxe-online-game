...
class Toast extends Sprite
{
	...
	public function new(titleText:String, titleColor:Int = 0x8A8A8A, description:String)
	{
		...
		title.setTextFormat(new TextFormat(Paths.getPath("font/vcr.ttf"), 24, titleColor, true));
		title.wordWrap = true;
		title.width = 360;
		title.y = 5;
		title.x = 5;
		...
		desc.setTextFormat(new TextFormat(Paths.getPath("font/vcr.ttf"), 18, 0xFFFFFF));
		desc.wordWrap = true;
		desc.width = 360;
		desc.height = 95;
		desc.y = 30;
